...
object CropKnowledge {
    ...
    fun characteristics(cropName: String): com.soilandsupper.shared.domain.model.CropCharacteristics? {
        val crop = catalog.firstOrNull { it.name.equals(cropName, ignoreCase = true) } ?: return null
        return com.soilandsupper.shared.domain.model.CropCharacteristics(
