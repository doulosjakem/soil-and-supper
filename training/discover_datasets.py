...
APPROVED_DATASETS = {
    ...
    "segppd101": {
        ...
        "download_url": "https://github.com/umerzaid007/Seg-PPD-101/raw/main/SegPPD-101.rar",
        "license": "MIT",
        "commercial_ok": True,
        "domain": "diseases",
        "priority": 2,
        "status": "ACQUIRED",
        "classes": [
            "apple_healthy", "apple_powdery mildew", "apple_frog eye leaf spot",
            "apple_rust", "apple_scab", "bean_healthy", "bean_angular leaf spot",
            "bean_rust", "corn_healthy", "corn_blight", "corn_rust",
            "corn_gray leaf spot", "cucmber_healthy", "cucmber_powdery mildew",
            "cucmber_gray mold", "eggplant_healthy", "eggplant_early blight",
            "eggplant_leaf mold", "eggplant_necrotic leaf spot", "eggplant_powdery mildew",
            "grape_healthy", "grape_black rot", "grape_powdery mildew",
            "grape_yellow blight", "okra_healthy", "okra_powdery mildew",
            "pepper_healthy", "pepper_bacterial spot", "strawberry_healthy",
            "strawberry_calcium deficiency", "strawberry_leaf scorch",
            "tomato_healthy", "tomato_bacterial spot", "tomato_mold",
            "tomato_late blight", "tomato_powdery mildew"
        ],
        "image_count": 2263,
