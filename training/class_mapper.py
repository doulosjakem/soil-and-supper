...
def initialize_default_mappings():
    ...
    # PlantVillage (diseases) — exact directory names from HuggingFace data.zip
    ...
    # BIOSCAN-5M (insects — specimen-style, DEFERRED for direct training)
    bioscan_mappings = [
        ("Aphis", "Aphid"),
        ("Rhopalosiphum", "Aphid"),
        ("Acyrthosiphon", "Aphid"),
        ...
        ("Cinara", "Aphid"),
        ("Bemisia", "Whitefly"),
        ("Trialeurodes", "Whitefly"),
        ("Tetranychus", "Spider_mite"),
        ("Panonychus", "Spider_mite"),
        ("Oligonychus", "Spider_mite"),
        ("Liriomyza", "Leafminer"),
        ("Phytomyza", "Leafminer"),
        ("Calycomyza", "Leafminer"),
        ("Pseudonapomyza", "Leafminer"),
        ("Agromyza", "Leafminer"),
        ("Ophiomyia", "Leafminer"),
        ("Hippodamia", "Ladybug"),
        ("Coleomegilla", "Ladybug"),
        ("Coccinella", "Ladybug"),
        ("Harmonia", "Ladybug"),
        ("Adalia", "Ladybug"),
        ("Propylea", "Ladybug"),
        ("Chrysoperla", "Green_lacewing"),
        ("Chrysopa", "Green_lacewing"),
        ("Ceraeochrysa", "Green_lacewing"),
        ("Mallada", "Green_lacewing"),
        ("Plesiochrysa", "Green_lacewing"),
        ("Apis", "Honey_bee"),
        ("Toxomerus", "Hoverfly"),
        ("Paragus", "Hoverfly"),
        ...
        ("Eupeodes", "Hoverfly"),
        ("Episyrphus", "Hoverfly"),
        ("Eristalinus", "Hoverfly"),
        ("Chaetocnema", "Flea_beetle"),
        ("Epitrix", "Flea_beetle"),
        ("Phyllotreta", "Flea_beetle"),
        ("Longitarsus", "Flea_beetle"),
        ...
        ("Euxoa", "Cutworm"),
        ("Feltia", "Cutworm"),
        ("Helicoverpa", "Corn_earworm"),
        ("Heliothis", "Corn_earworm"),
        ("Anasa", "Squash_bug"),
        ("Leptoglossus", "Squash_bug"),
        ("Halyomorpha", "Stink_bug"),
        ("Nezara", "Stink_bug"),
        ("Acrosternum", "Stink_bug"),
        ("Euschistus", "Stink_bug"),
        ("Thyanta", "Stink_bug"),
        ("Banasa", "Stink_bug"),
        ("Meloe", "Blister_beetle"),
        ("Epicauta", "Blister_beetle"),
        ("Lytta", "Blister_beetle"),
        ("Hycleus", "Blister_beetle"),
    ]
