...
def initialize_default_verifications():
    ...
    defaults = [
        ...
        },
        {
            ...
            "name": "SegPPD-101 (Semantic Segmentation of Plant Disease Images)",
            "url": "https://github.com/umerzaid007/Seg-PPD-101",
            "license_type": "MIT",
            ...
            "no_derivatives": False,
            "tos_restrictions": "",
            "verification_source": "GitHub repository + Kaggle dataset page",
            "verification_notes": "GitHub repository and associated Kaggle dataset page both list MIT license. 2,263 field/outdoor images, 101 classes, 256x256 RGB PNG. Commercially usable without attribution.",
        },
        {
            ...
            "no_derivatives": False,
            "tos_restrictions": "",
            "verification_source": "Zenodo dataset page + peer-reviewed article (PMC12020891)",
            "verification_notes": "Zenodo record shows CC BY 4.0 license. 117,418 smartphone field images from Tanzania (earlyblt 35,544, lateblt 40,998, healthy 40,876). Images collected using Samsung Galaxy A03 smartphones on smallholder farms. Commercially usable with attribution.",
        },
        {
            ...
            "no_derivatives": False,
            "tos_restrictions": "",
            "verification_source": "Zenodo dataset page + peer-reviewed article (PMC8933512)",
            "verification_notes": "Zenodo record shows CC BY 4.0 license. 118,142 smartphone field images from Tanzania (rust 41,136, anthracnose 27,062, healthy 49,944). Images collected using Samsung Galaxy A03 Core smartphones on smallholder farms. Commercially usable with attribution.",
        },
        {
            ...
            "no_derivatives": False,
            "tos_restrictions": "",
            "verification_source": "Zenodo dataset page + Data in Brief article (2026)",
            "verification_notes": "Zenodo record shows CC BY 4.0 license. 5,267 smartphone field images from Portuguese vineyards (Downy Mildew, Powdery Mildew, Esca, Erineum Mite, Healthy). 1024x1024 resized JPG. Commercially usable with attribution.",
        },
        {
