...
import com.soilandsupper.ui.util.epochMillis

object AppTestGardenFixture {
    ...
    val spaces: List<GrowingSpace>
        get() = listOf(
            GrowingSpace(id = 1L, name = "Bed 1 - Garlic", notes = "Garlic succession"),
            GrowingSpace(id = 2L, name = "Bed 2 - Potatoes", notes = "Potatoes / Onions"),
            GrowingSpace(id = 3L, name = "Bed 3 - Corn", notes = "Flour corn"),
            GrowingSpace(id = 4L, name = "Fabric Pot 1", notes = "Tomatoes"),
            GrowingSpace(id = 5L, name = "Fabric Pot 2", notes = "Dry Beans"),
            GrowingSpace(id = 6L, name = "Empty Bed", notes = "Available for planting")
        )
